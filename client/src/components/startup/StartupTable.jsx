...
export const StartupTable = ({ startups, onOpenProfile, onEdit, onDelete, onEvaluate }) => {
          ...
          <tbody className="divide-y divide-slate-100 font-display">
            {startups.map((startup) => {
              return (
                <tr
                  key={startup._id}
                  onClick={() => (onOpenProfile ? onOpenProfile(startup) : null)}
                ...
                >
                  ...
                  <td className="px-5 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="font-extrabold text-slate-950 group-hover:text-emerald-700 transition-colors block">
                          {startup.companyName}
                        </span>
                        {startup.website && (
                  ...
                  <td className="px-4 py-4 whitespace-nowrap">
                    <div>
                      ...
                      {startup.founder?.background && (
                        <div className="text-slate-500 text-[10px] font-medium truncate max-w-[140px]">
                          {startup.founder.background}
                        </div>
                      )}
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-end gap-1.5">
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-xl text-[11px] font-bold font-display text-slate-700 bg-[#f4f7f4] hover:bg-slate-200 transition-colors flex items-center gap-1"
                        title="Edit Details"
                      >
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl text-xs font-black font-display text-slate-950 bg-[#9df5a9] hover:bg-[#8ee59a] transition-colors ml-1 inline-flex items-center gap-1.5 shadow-xs"
